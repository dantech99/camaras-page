...
export const HeroSection = () => {
    ...
    return (
        <div className="relative h-[50vh] w-full overflow-hidden sm:h-[60vh] md:h-[70vh] lg:h-[90vh]">
                ...
                >
                    ...
                    >
                        <div className="max-w-3xl">
                            ...
                            <p className="max-w-xl text-sm text-gray-300 md:text-base">{slides[currentSlide].description}</p>

                            {/* Futuristic button */}
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="mt-4 flex items-center gap-2 rounded-md border border-cyan-500/50 bg-black/50 px-4 py-2 font-mono text-sm text-cyan-400 backdrop-blur-sm transition-colors hover:bg-cyan-950/30 md:mt-6"
                            >
                                Explorar
                    ...
                    >
                        <span
                            className={cn(
                                ...
                                currentSlide === index && autoplay ? "translate-x-0" : "-translate-x-full",
                            )}
                        />
                    </button>
                ))}
