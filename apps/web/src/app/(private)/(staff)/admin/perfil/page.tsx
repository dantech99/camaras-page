...
import { Loader2, Globe, MapPin, Mail, Phone } from "lucide-react";
          ...
          <Card className="overflow-hidden max-w-[400px] w-full rounded-lg shadow-md">
            ...
            <div className="relative h-32 w-full">
              {data.user.image ? (
                <>
                  <Image
                    src={
                      data.user.image || "/placeholder.svg?height=128&width=350"
                    }
                    alt="Banner"
                    fill
            ...
            <div className="flex justify-center -mt-16">
              <div className="relative w-32 h-32 rounded-full overflow-hidden bg-white border-4 border-card">
                {data.user.image ? (
                  <Image
                    src={
                      data.user.image || "/placeholder.svg?height=128&width=128"
                    }
                    alt={data.user.name}
                    fill
                    className="object-cover"
            ...
            <div className="p-4 text-center">
              <h2 className="text-xl font-bold">
                {data.user.nameTag || data.user.name}
              </h2>
