                    ...
                    <div className="flex gap-2">
                        <Tabs defaultValue="login" className="w-full">
                            <TabsList className="grid w-full grid-cols-2 rounded-full">
                                <TabsTrigger value="login" className="transition-colors duration-500 rounded-full">Iniciar sesión</TabsTrigger>
                                <TabsTrigger value="signup" className="transition-colors duration-500 rounded-full">Registrarse</TabsTrigger>
                            </TabsList>
                            <TabsContent value="login" className="transition-opacity duration-1000 animate-in fade-in">
                                <LoginForm />
                            </TabsContent>
                            <TabsContent value="signup" className="transition-opacity duration-1000 animate-in fade-in">
                                <RegisterForm />
                            </TabsContent>
                        </Tabs>
                    </div>
