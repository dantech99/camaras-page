                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 md:p-4 flex items-center gap-2 sm:gap-3">
                                    <Avatar className="h-8 w-8 sm:h-10 sm:w-10 shadow-md flex-shrink-0">
                                        <AvatarFallback className="bg-cyan-500 text-white" title={card.name}>{card.name.charAt(0)}</AvatarFallback>
                                    </Avatar>
                                    <div className="min-w-0">
                                        <p className="text-white font-medium text-xs sm:text-sm truncate">{card.photographer}</p>
                                        <p className="text-gray-300 text-xs truncate">{card.name}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
