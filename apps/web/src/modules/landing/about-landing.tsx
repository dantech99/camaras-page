          ...
          <div className="w-full md:w-3/5 text-white space-y-5">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold flex flex-wrap items-center">
              ...
              <span className="text-primary-blue mx-2 relative inline-block animate-pulse">
                ...
                <span className="absolute -bottom-1 -left-2 text-xs text-primary animate-bounce">
                  ✦
                </span>
              </span>
              <span>?</span>
            ...
            <p className="text-base sm:text-lg opacity-90">
              At Las Cámaras del Dragón, we are a passionate team of
              professional photographers dedicated to capturing the
              unforgettable moments at SOFA, one of the most vibrant and
              exciting geek culture events in Latin America. Our mission is
              simple – to immortalize the energy, creativity, and excitement of
              every cosplayer, fan.
            </p>

            <p className="text-base sm:text-lg opacity-90">
              Whether you're showcasing an intricate cosplay, posing with
              friends, or simply soaking in the electric atmosphere of the
